// Mock D3 functionality for testing SimulationTreeVisualization
const d3Mock = {
  ...
  tree: jest.fn().mockReturnValue((root: any) => root),
  cluster: jest.fn().mockReturnValue((root: any) => root),
  radialTree: jest.fn().mockReturnValue((root: any) => root),
  ...
  // Scale functions
  scaleOrdinal: jest.fn().mockReturnValue((d: any) => '#cccccc'),
  scaleLinear: jest.fn().mockReturnValue((d: any) => 1),
  ...
  scaleDiverging: jest.fn().mockReturnValue({
    domain: jest.fn().mockReturnThis(),
    range: jest.fn().mockReturnThis(),
    copy: jest.fn().mockReturnThis(),
    clamp: jest.fn().mockReturnThis(),
